...
#define DEFAULT_bedKp 237.51 //New PID
...
//#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 18, 18, 0.6, 10 } // ...or, set your own edit limits
  #endif
#endif
...
//#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_ENABLED_DEFAULT false//true // Это датчик филамента! Enable the sensor on startup. Override with M412 followed by M500.
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 25.0 // (mm) Default fade height.
  #endif
