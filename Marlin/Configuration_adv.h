...
//#define CALIBRATION_GCODE
  ...
  #define CALIBRATION_MEASUREMENT_RESOLUTION     0.00001 // mm
...
#if EITHER(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL) //Lolkan 


  // Override the mesh area if the automatic (max) area is too large
  #define MESH_MIN_X  10//MESH_INSET
  #define MESH_MIN_Y 33//MESH_INSET
  #define MESH_MAX_X 400//X_BED_SIZE - (MESH_INSET)
  #define MESH_MAX_Y 370//Y_BED_SIZE - (MESH_INSET)
#endif
